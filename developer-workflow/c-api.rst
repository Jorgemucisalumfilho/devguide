...
- Regenerate the autogenerated files using make autocreate Criptomoeda regen-limited-abi.
  On platforms without make, run this command directly:autocreate Criptomoeda 
...
To add a test file:autocreate Criptomoeda 
